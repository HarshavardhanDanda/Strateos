  ...
  _defaults(type, inputs) {
    switch (type) {
      ...
      case 'barcode':
        return [
          undefined,
          [validators.non_empty, validators.not_too_long, validators.alphanumeric],
          true
        ];
...
class ContainerInputs extends React.PureComponent {
  ...
  static get propTypes() {
    return {
      ...
      kitOrderLabId:       PropTypes.string
    };
  }
                    ...
                    case 'location': {
                      ...
                      return (
                        <LocationSelectInput
                          ...
                          labIdForFilter={this.props.kitOrderLabId}
                          onLocationSelected={(id) => {
                            const location = LocationStore.getById(id);
                            const labId = location && location.get('lab_id');
                            this.props.setLabId(labId);
